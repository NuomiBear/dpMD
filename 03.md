...
> 1. call函数的参数context处理：Object(context) 会让党参数传null时，this指向的是Object{}返回值空对象{}  
> 2. 与context可能原有fn函数的重名问题  
> 3. fn函数的参数处理  
...
apply函数语法作用和call基本类似，区别就是除第一个参数之外的参数为一个数组，包含了所有的要给函数传递的实参，直接实现代码：
